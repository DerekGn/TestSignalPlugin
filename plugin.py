...
#
"""
<plugin key="SignalTest" name="Signal Test Example" author="" version="1.0.0" wikilink="http://www.domoticz.com/wiki/plugins/plugin.html" externallink="https://www.google.com/">
    <description>
...
class BasePlugin:
    ...
    def onCommand(self, DeviceID, Unit, Command, Level, Color):
        ...
        Devices[DeviceID].Units[Unit].BatteryLevel = Level
        Devices[DeviceID].Units[Unit].SignalLevel = Level
